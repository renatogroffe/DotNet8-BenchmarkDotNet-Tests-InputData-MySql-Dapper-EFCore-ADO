...
using BenchmarkingDapperEFCoreCRMMySql.EFCore;
...
namespace BenchmarkingDapperEFCoreCRMMySql.Tests;
...
public class CRMTests
{
    ...
    private MySqlConnection? _connectionDapper;
    ...
    {
        _connectionDapper = new MySqlConnection(Configurations.BaseDapper);
    ...
    public Dapper.Empresa InputDataWithDapper()
    {
        ...
        empresa.IdEmpresa = _connectionDapper.QuerySingle<int>(
            ...
            "SELECT LAST_INSERT_ID();", empresa, transaction);
        ...
        for (int i = 0; i < _numeroContatosPorCompanhiaDapper; i++)
        {
            ...
            contato.IdContato = _connectionDapper.QuerySingle<int>(
                ...
                "SELECT LAST_INSERT_ID();", contato, transaction);
    ...
    private MySqlConnection? _connectionDapperContrib;
    ...
    {
        _connectionDapperContrib = new MySqlConnection(Configurations.BaseDapperContrib);
    ...
    private MySqlConnection? _connectionADO;
    ...
    {
        _connectionADO = new MySqlConnection(Configurations.BaseADO);
    ...
    public Dapper.Empresa InputDataWithADO()
    {
        ...
        using var commandInsertEmpresa = _connectionADO.CreateCommand();
        commandInsertEmpresa.CommandText =
        ...
        commandInsertEmpresa.ExecuteNonQuery();
        empresa.IdEmpresa = (int)commandInsertEmpresa.LastInsertedId;
        ...
        for (int i = 0; i < _numeroContatosPorCompanhiaADO; i++)
        {
            ...
            using var commandInsertContato = _connectionADO.CreateCommand();
            commandInsertContato.CommandText =
            ...
            commandInsertContato.ExecuteNonQuery();
            contato.IdContato = (int)commandInsertContato.LastInsertedId;
            empresa.Contatos.Add(contato);
        }
